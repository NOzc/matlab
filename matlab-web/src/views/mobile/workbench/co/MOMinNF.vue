<template>
  <div class="minnf-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用内点罚函数法求解约束多维函数的极值</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">约束函数g：</td>
                        <td><el-input clearable v-model="parameters.g.gl" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.g.gr" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">罚因子u：</td>
                        <td><el-input clearable v-model="parameters.u" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">缩小系数v：</td>
                        <td><el-input clearable v-model="parameters.v" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
