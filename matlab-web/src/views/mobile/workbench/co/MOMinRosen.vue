<template>
  <div class="minrosen-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用Rosen梯度投影法求解约束多维函数的极值</div>
          ...
          <div style="margin-top: 0">
            <el-tabs type="border-card" :stretch="true">
              <el-tab-pane label="参数设置">
                <!--参数-->
                <div style="height: 487px" class="numresdiv">
                  <div>
                    <table>
                      <tr>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">约束矩阵A[1]：</td>
                        <td><el-input clearable v-model="parameters.a1.a1l" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.a1.a1r" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">约束矩阵A[2]：</td>
                        <td><el-input clearable v-model="parameters.a2.a2l" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.a2.a2r" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        ...
                        <td><el-input clearable v-model="parameters.b.bl" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.b.br" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
...
export default {
  ...
  data() {
    return {
      activeName: 'home',
      parameters: {
        func:'2*t^2+s^2-2*t*s+3*t-8*s+2',
        a1:{a1l:0,a1r:0},
        a2:{a2l:-3,a2r:5},
        b:{bl:-4,br:-8},
        x0:{x0l:0,x0r:0},
...
<style>
.minrosen-mobile .el-tabs__content{
  overflow: scroll;
}
</style>