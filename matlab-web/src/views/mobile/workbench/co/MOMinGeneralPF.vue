<template>
  <div class="mingreneralpf-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用外点罚函数法求解一般等式约束多维函数的极值</div>
...
<style>
.mingreneralpf-mobile .el-tabs__content{
  overflow: scroll;
}
</style>