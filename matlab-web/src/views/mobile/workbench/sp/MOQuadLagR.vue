<template>
  <div class="quadlagr-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用拉格朗日法求解等式约束的凸二次规划</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">二次规划一次性向量c：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">等式约束系数矩阵A：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">等式约束右端向量b：</td>
...
<style>
.quadlagr-mobile .el-tabs__content{
  overflow: scroll;
}
</style>