<template>
  <div class="activdeset-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用起作用集法求解不等式约束的凸二次规划</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">二次规划一次项系数向量x：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">不等式约束系数矩阵A：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">不等式约束右端向量b：</td>
                        <td><el-input clearable v-model="parameters.z.b" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">x0：</td>
                        <td><el-input clearable v-model="parameters.z.x0" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始约束指标集AcSet：</td>
                        <td><el-input clearable v-model="parameters.AcSet" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
...
<style>
.activdeset-mobile .el-tabs__content{
  overflow: scroll;
}
</style>