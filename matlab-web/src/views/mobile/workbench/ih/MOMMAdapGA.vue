<template>
  <div class="mmadapga-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#802c8c;color: #ffffff;font-size:14px;height:44px">用多变异位自适应遗传优化求解一维无约束优化问题</div>
...
<style>
.mmadapga-mobile .el-tabs__content{
  overflow: scroll;
}
</style>