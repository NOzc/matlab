<template>
  <div class="minzerooneprog-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用枚举法(包括穷举法和隐枚举法)求解0-1规划</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  <div>
                    <table>
                      <tr>
                        <td style="width: 53%">目标函数系数向量c：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 53%">不等式约束右端向量b：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 53%">初始可行整数解x0：</td>
...
<style>
.minzerooneprog-mobile .el-tabs__content{
  overflow: scroll;
}
</style>