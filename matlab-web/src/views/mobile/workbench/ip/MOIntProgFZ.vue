<template>
  <div class="minintprogfz-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:14px;height:44px">用分支定界法求解整数规划</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  <div>
                    <table>
                      <tr>
                        <td style="width: 55%">目标函数系统向量f：</td>
                        <td><el-input clearable v-model="parameters.f" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 55%">不等式约束右端向量b：</td>
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 55%">等式约束矩阵Aeq：</td>
                        <td><el-input clearable v-model="parameters.Aeq" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 55%">等式约束右端向量beq：</td>
                        <td><el-input clearable v-model="parameters.beq" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 55%">自变量下届lb：</td>
                        <td><el-input clearable v-model="parameters.lb" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 55%">自变量下届ub：</td>
                        <td><el-input clearable v-model="parameters.ub" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
...
<style>
.minintprogfz-mobile .el-tabs__content{
  overflow: scroll;
}
</style>