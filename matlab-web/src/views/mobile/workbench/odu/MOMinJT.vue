<template>
  <div class="minjt-mobile">
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#802c8c;color: #ffffff;font-size:18px;height:44px">用进退法求解一维函数的极值区间</div>
                ...
                <div style="height: 487px">
                  <el-tabs>
                    ...
                    <el-tab-pane label="数值结果视图">
                      <div>
                        <div style="margin-top: 10%">区间左边界：</div>
                        <div><el-input v-model="result.minx"/></div>
                      </div>
                      <div style="margin-top: 10%">
                        <div>区间右边界：</div>
                        <div><el-input v-model="result.maxx"/></div>
                      </div>
                    </el-tab-pane>
                  </el-tabs>
                </div>
