<template>
  <div class="mings-mobile">
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#802c8c;color: #ffffff;font-size:18px;height:44px">用Goldstein法求解一维函数的极值</div>
