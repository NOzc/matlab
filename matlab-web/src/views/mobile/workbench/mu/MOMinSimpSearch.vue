<template>
  <div class="minsimpsearch-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:18px;height:44px">用单纯形搜索法求解多维函数的极值</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始单纯形x1：</td>
                        <td><el-input clearable v-model="parameters.x1.x1l" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.x1.x1r" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始单纯形x2：</td>
                        <td><el-input clearable v-model="parameters.x2.x2l" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.x2.x2r" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始单纯形x3：</td>
                        <td><el-input clearable v-model="parameters.x3.x3l" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.x3.x3l" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">反应系数alpha：</td>
...
<style>
.minsimpsearch-mobile .el-tabs__content{
  overflow: scroll;
}
</style>