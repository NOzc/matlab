<template>
  <div class="minrb-mobile">
    <!--标题-->
    <div style="padding: 25px 25px 35px 25px;position:fixed;left:0;right:0;top:0;text-align: center;background-color:#2d3a4b;color: #ffffff;font-size:18px;height:44px">用Rosenbrock法求解多维函数的极值</div>
              ...
              <el-tab-pane label="参数设置">
                ...
                <div style="height: 487px">
                  ...
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始正交向量...：</td>
                        <td><el-input clearable v-model="parameters.ov.ov1" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.ov.ov2" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始正交向量...：</td>
                        <td><el-input clearable v-model="parameters.ov.ov3" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.ov.ov4" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">初始步长delta：</td>
                        <td><el-input clearable v-model="parameters.delta.dl" :disabled="disabledStatus"></el-input></td>
                        <td><el-input clearable v-model="parameters.delta.dr" :disabled="disabledStatus"></el-input></td>
                      </tr>
                    </table>
                  </div>
                  <div style="margin-top: 20px">
                    <table>
                      <tr>
                        <td style="width: 40%">增大系数alpha：</td>
                  ...
                  <el-tabs>
                    ...
                    <el-tab-pane label="数值结果视图">
                      <div>
                        ...
                        <div><el-input v-model="numRes.minx"/></div>
                      </div>
                      <div style="margin-top: 10%">
                        <div>目标函数最小值minf：</div>
                        <div><el-input v-model="numRes.miny"/></div>
                      </div>
                    </el-tab-pane>
                  </el-tabs>
                </div>
