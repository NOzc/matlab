<template>
  <div class="mingeneralpf-pc">
    ...
    <div style="height: 12%;padding: 10px;position: relative;background-color:#283443;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" title="用枚举法(包括穷举法和隐枚举法)求解0-1规划"/>
    </div>
...
export default {
  ...
  methods: {
    run(payload) {
      //向后端发起请求，获取图像
      this.$refs.funcImgArea.displayZeroOneprog();
