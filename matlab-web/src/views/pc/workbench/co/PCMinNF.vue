<template>
  <div class="minnf-pc">
    ...
    <div style="height: 12%;padding: 10px;position: relative;background-color:#283443;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" title="用内点罚函数法求解约束多维函数的极值"/>
    </div>
...
export default {
  ...
  methods: {
    run(payload) {
      //向后端发起请求，获取图像
      this.$refs.funcImgArea.displayMinNF();
...
<style>
.minnf-pc .dialog-container .el-dialog{
  height: 60%;
}/*
