<template>
  <div class="minrosen-pc">
    <!--  顶部标题部分  -->
    <div style="height: 12%;padding: 10px;position: relative;background-color:#283443;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" title="用Rosen梯度投影法求解约束多维函数的极值"/>
    </div>
...
export default {
  ...
  methods: {
    run(payload) {
      //向后端发起请求，获取图像
      this.$refs.funcImgArea.displayMinRosen();
...
<style>
.minrosen-pc .dialog-container .el-dialog{
  height: 60%;
}/*
