<template>
  <div class="mingeneralpf-pc">
    ...
    <div style="height: 12%;padding: 10px;position: relative;background-color:#283443;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" title="用外点罚函数法求解一般等式约束多维函数的极值"/>
    </div>
...
export default {
  ...
  methods: {
    run(payload) {
      //向后端发起请求，获取图像
      this.$refs.funcImgArea.displayMinGeneralPF();
