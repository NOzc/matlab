<template>
  <div class="mingx-pc" style="height: 100vh;width: 100%;">
    <!--  顶部标题部分  -->
    <div style="height: 15%;padding: 10px;position: relative;background-color: #802c8c;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" @resetAllSettings='resetAllSettings' title="用割线法求解一维函数的极值"/>
    </div>
...
export default {
  ...
  methods: {
    ...
    resetAllSettings(){
      ...
      this.parameters.x0=5
      this.parameters.x1=8
...
<style>
.mingx-pc .dialog-container .el-dialog{
  height: 60%;
}
</style>