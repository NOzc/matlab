<template>
  <div class="minrb-pc" style="height: 100vh;width: 100%;">
    <!--  顶部标题部分  -->
    <div style="height: 15%;padding: 10px;position: relative;background-color: #802c8c;">
      <p-c-title-area @run="run" @pause="pause" @displayDrawer="displayDrawer" @showDialog="showDialog" @resetAllSettings='resetAllSettings' title="用Rosenbrock法求解多维函数的极值"/>
    </div>
      ...
      <div id="workarea" style="height: 100%;width: 30%;position: absolute;">
        <p-c-params-area ref="paramsArea">
          ...
          <table>
            ...
            <tr>
              <td>初始正交向量...：</td>
              <td><el-input clearable v-model="parameters.ov[0][0]" :disabled="disabledStatus"></el-input></td>
              <td><el-input clearable v-model="parameters.ov[0][1]" :disabled="disabledStatus"></el-input></td>
            </tr><br/>
            <tr>
              <td>初始正交向量...：</td>
              <td><el-input clearable v-model="parameters.ov[1][0]" :disabled="disabledStatus"></el-input></td>
              <td><el-input clearable v-model="parameters.ov[1][1]" :disabled="disabledStatus"></el-input></td>
            </tr><br/>
            <tr>
              <td>初始步长delta：</td>
            ...
            <tr>
              <td style="width: 150px">增大系数alpha：</td>
...
export default {
  ...
  methods: {
    run(payload) {
      //向后端发起请求，获取图像
      // this.$refs.funcImgArea.displayMinRb();
    ...
    resetAllSettings(){
      ...
      this.parameters.x0=[0,0]
      this.parameters.ov=[[1,0],[0,1]]
      this.parameters.delta=[1,1]
      this.parameters.alpha =3
      this.parameters.beta=0.5
...
<style>
.minrb-pc .dialog-container .el-dialog{
  height: 60%;
}/*
